...
//     Route::post('/paiements/storeLigne', [PaiementController::class, 'storeLigne'])->name('paiements.storeLigne');
...
//     Route::get('/mobileMoneys/createLigne', [MobileMoneyController::class, 'createEnligne'])->name('mobiles.create_or_update');
// });
